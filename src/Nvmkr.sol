...
/**
 * Non-voting MKR can be minted from voting MKR, but can only be burned
 * by someone who previously minted it. This allows price exposure to 
 * borrowed MKR without giving up voting rights to the lender.
 */
contract Nvmkr is IERC20 {
     ...
     * construction.
     */
    constructor (address mkr_, string memory name, string memory symbol) public {
        mkr = IERC20(mkr_);
    ...
    function mint(address account, uint256 amount) external {
        ...
        require(mkr.transferFrom(msg.sender, address(this), amount));
        mints[msg.sender] = add(mints[msg.sender], amount);
    ...
    function burn(address account, uint256 amount) internal virtual {
        ...
        mints[msg.sender] = sub(mints[msg.sender], amount);
        mkr.transfer(msg.sender, amount);
